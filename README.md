...
1. Modifying makeup overlays and eyebrows reset the Hair Overlays for the female characters. By doing `reloadskin` command, the character eyebrows and hair overlays are fixed (Hair Overlays is not something important or used by many female characters, its very rare to be used eitherway).

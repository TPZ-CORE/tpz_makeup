...
Config.Stores = {
	...
	['SAINT_DENIS'] = {
        ...
        -- The makeup store coords - also for teleporting the player for the proper location.
		Coords = { x = 2548.539, y = -1158.57, z = 52.727, h = 236.083251953 },

		CameraCoords = { x = 2550.500, y = -1160.36, z = 54.328, h = 45.04130935, roty = 0.0, rotz = 48.0, zoom = 10.0},
        ...
        BlipData = {
            ...
            DisplayClosedHours = { Enabled = true, Sprite = 1451797164, BlipModifier = "BLIP_MODIFIER_MP_COLOR_2" },
        },

		Hours = { Allowed = false, Opening = 7, Closing = 23 },

        ActionMarkers = {
            Enabled = true,
            Coords = {x = 2548.539, y = -1158.57, z = 53.727 },
            Distance = 5.0,
            RGBA = {r = 255, g = 255, b = 255, a = 100},
        },

        Lighting = vector3(2548.960, -1158.70, 54.128),
